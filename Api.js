...
const duplicateBrands = Object.keys(brandCounts).filter(brand => brandCounts[brand] > 1);
...
// fetchData('https://jsonplaceholder.typicode.com/todos/1', handleResponse);

// Output:
// (Response data from the URL or an error message)
